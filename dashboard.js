(function () {
  ...
  function availableTabs() {
    ...
    if (state.accountType === "professional" || state.role === "admin") {
      const companyTabs=[["business", "Обзор компании"],["business-inventory", "Склад"],["business-auctions", "Массовые торги"],["business-feeds", "Фиды"],["business-team", "Филиалы и сотрудники"],["market-analytics", "Оценка цены"]];
