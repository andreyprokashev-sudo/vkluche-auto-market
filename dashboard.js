(function () {
  ...
  let state = { role: "user", accountType: "private", active: "overview", listingFilter: "all", inventorySearch: "", reportPeriod: "30", analyticsPeriod: "90", data: {} };
  const esc = (value) =>
  ...
  function availableTabs() {
    ...
    if (state.accountType === "professional" || state.role === "admin") {
      const companyTabs=[["business", "Обзор компании"],["business-inventory", "Склад"],["inventory-recommendations", "Рекомендации"],["business-auctions", "Массовые торги"],["business-feeds", "Фиды"],["business-team", "Филиалы и сотрудники"],["market-analytics", "Оценка цены"]];
