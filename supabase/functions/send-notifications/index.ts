...
function maxActions(type:string,auctionId?:string,listingId?:string,questionId?:string,auctionStatus?:string){
  ...
  if(type==='history_report_ready')return[{type:'inline_keyboard',payload:{buttons:[[{type:'link',text:'Скачать отчёт',url:'https://andreyprokashev-sudo.github.io/vkluche-auto-market/?cabinet=my-inquiries'}]]}}]
