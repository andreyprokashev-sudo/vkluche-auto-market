...
function maxActions(type:string,auctionId?:string,listingId?:string,questionId?:string){
...
async function sendMax(chatId:string,subject:string,body:string,type:string,auctionId?:string,listingId?:string,questionId?:string){
  if(!maxToken)throw new Error('MAX_BOT_TOKEN не настроен')
  const attachments=maxActions(type,auctionId,listingId,questionId)
...
async function sendTelegram(chatId:string,subject:string,body:string,type:string,auctionId?:string,listingId?:string,questionId?:string){
